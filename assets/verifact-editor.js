((wp)=>{
  ...
  const ReviewPanel=()=>{
    ...
    return el(PluginDocumentSettingPanel,{name:'verifact-review',title:'VeriFact Review',className:'verifact-review-panel'},
      ...
      el('p',{id:'verifact-review-help',className:'description'},'VeriFact reuses unchanged claim results. After review, compact source links publish beside factual claims in normal prose.'),
